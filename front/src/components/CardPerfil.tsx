...
export function CardPerfil() {
    ...
    return (
        <div className="absolute bg-gray-100 px-3 py-2 md:px-5 md:py-4 flex flex-col gap-2 md:gap-4 rounded-md md:rounded-lg border border-gray-300 z-10 md:w-35 -right-5 -bottom-31 md:-right-11/12 md:-bottom-3/12">
